...
alterState(async state => {
  ...
  const mapping = {
    ...
    Latitude: latlong.latitude===undefined || latlong.latitude===null || latlong.latitude===''
      ? latlong.latitude
      : dataValue('$.body.plot_gps')(state).split(' ')[0],
    Longitude: latlong.longitude===undefined || latlong.longitude===null || latlong.longitude===''
      ? latlong.longitude
      : dataValue('$.body.plot_gps')(state).split(' ')[0],
    PlotNumber: state => {
