...
fn(async state => {
 const mapping = {
  ...
  TT_ProportionID_PropSettlement: await findValue({uuid: 'tt_proportionid', relation: 'TT_LandProportion', where: { TT_proportionExtCode: dataValue('prop_settlement') }})(state),
  TT_ProportionID_PropWetland: await findValue({uuid: 'tt_proportionid', relation: 'TT_LandProportion', where: { TT_proportionExtCode: dataValue('prop_wetland') }})(state),
  TT_ProportionID_PropNativeVeg: await findValue({uuid: 'tt_proportionid', relation: 'TT_LandProportion', where: { TT_proportionExtCode: dataValue('prop_native_veg') }})(state),
  TT_ProportionID_PropFallowLand: await findValue({uuid: 'tt_proportionid', relation: 'TT_LandProportion', where: { TT_proportionExtCode: dataValue('prop_fallow_land') }})(state),
  TT_ProportionID_PropGrazingLand: await findValue({uuid: 'tt_proportionid', relation: 'TT_LandProportion', where: { TT_proportionExtCode: dataValue('prop_grazing_land') }})(state),
  TT_ProportionID_PropCropLand: await findValue({uuid: 'tt_proportionid', relation: 'TT_LandProportion', where: { TT_proportionExtCode: dataValue('prop_crop_land') }})(state),
