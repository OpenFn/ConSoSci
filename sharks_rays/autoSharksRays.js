...
alterState(async state => {
 const mapping = {
  ...
  Pic2: dataValue('pic2'),
  Pic1: dataValue('pic1'),
  WCSPROGRAMS_SurveyorID_Surveyor: await findValue({uuid: 'wcsprograms_surveyorid', relation: 'WCSPROGRAMS_surveyor', where: { WCSPROGRAMS_surveyorExtCode: dataValue('surveyor') }})(state),
  WCSPROGRAMS_MarketID_Market: await findValue({uuid: 'wcsprograms_marketid', relation: 'WCSPROGRAMS_market', where: { WCSPROGRAMS_marketExtCode: dataValue('market') }})(state),
  WCSPROGRAMS_SiteID_LandingSite: await findValue({uuid: 'wcsprograms_siteid', relation: 'WCSPROGRAMS_site', where: { WCSPROGRAMS_siteExtCode: dataValue('landing_site') }})(state),
  WCSPROGRAMS_SurveyID_Survey: await findValue({uuid: 'wcsprograms_surveyid', relation: 'WCSPROGRAMS_survey', where: { WCSPROGRAMS_surveyExtCode: dataValue('survey') }})(state),
...
each(dataPath('market_details[*]'), alterState(async state => {
 const dataArray = state.data['market_details/vendor/sales'] || [] 
          ...
          for (let x of dataArray) { 
            ...
            mapping.push({
  WCSPROGRAMS_TypeID_SType: await findValue({uuid: 'wcsprograms_typeid', relation: 'WCSPROGRAMS_type', where: { WCSPROGRAMS_typeExtCode: dataValue('market_details/vendor/sales/s_type') }})(state),
  WCSPROGRAMS_GenusID_SGenus: await findValue({uuid: 'wcsprograms_genusid', relation: 'WCSPROGRAMS_genus', where: { WCSPROGRAMS_genusExtCode: dataValue('market_details/vendor/sales/s_genus') }})(state),
  WCSPROGRAMS_SpeciesID_SSpecies: await findValue({uuid: 'wcsprograms_speciesid', relation: 'WCSPROGRAMS_species', where: { WCSPROGRAMS_speciesExtCode: dataValue('market_details/vendor/sales/s_species') }})(state),
  ...
  WCSPROGRAMS_SexID_SSex: await findValue({uuid: 'wcsprograms_sexid', relation: 'WCSPROGRAMS_sex', where: { WCSPROGRAMS_sexExtCode: dataValue('market_details/vendor/sales/s_sex') }})(state),
  ...
  WCSPROGRAMS_YesnoID_SDnaSampleCollected: await findValue({uuid: 'wcsprograms_yesnoid', relation: 'WCSPROGRAMS_yesno', where: { WCSPROGRAMS_yesnoExtCode: dataValue('market_details/vendor/sales/s_dna_sample_collected') }})(state),
...
alterState(async state => {
 const dataArray = state.data['market_details/vendor'] || [] 
          ...
          for (let x of dataArray) { 
            ...
            mapping.push({
  WCSPROGRAMS_SexID_VendorSex: await findValue({uuid: 'wcsprograms_sexid', relation: 'WCSPROGRAMS_sex', where: { WCSPROGRAMS_sexExtCode: dataValue('market_details/vendor/vendor_sex') }})(state),
  WhenLastSellSharkRay: x['market_details/vendor/when_last_sell_shark_ray'],
  WCSPROGRAMS_VendorID_WhereBought: await findValue({uuid: 'wcsprograms_vendorid', relation: 'WCSPROGRAMS_vendor', where: { WCSPROGRAMS_vendorExtCode: dataValue('market_details/vendor/where_bought') }})(state),
  WCSPROGRAMS_VendorID_WhoSoldTo: await findValue({uuid: 'wcsprograms_vendorid', relation: 'WCSPROGRAMS_vendor', where: { WCSPROGRAMS_vendorExtCode: dataValue('market_details/vendor/who_sold_to') }})(state),
...
each(dataPath('boat[*]'), alterState(async state => {
 const dataArray = state.data['boat/fish_catch'] || [] 
          ...
          for (let x of dataArray) { 
            ...
            mapping.push({
  WCSPROGRAMS_FishID_FishSpecie: await findValue({uuid: 'wcsprograms_fishid', relation: 'WCSPROGRAMS_fish', where: { WCSPROGRAMS_fishExtCode: dataValue('boat/fish_catch/fish_specie') }})(state),
...
each(dataPath('boat[*]'), alterState(async state => {
 const dataArray = state.data['boat/catch_details'] || [] 
          ...
          for (let x of dataArray) { 
            ...
            mapping.push({
  WCSPROGRAMS_TypeID_Type: await findValue({uuid: 'wcsprograms_typeid', relation: 'WCSPROGRAMS_type', where: { WCSPROGRAMS_typeExtCode: dataValue('boat/catch_details/type') }})(state),
  WCSPROGRAMS_GenusID_Genus: await findValue({uuid: 'wcsprograms_genusid', relation: 'WCSPROGRAMS_genus', where: { WCSPROGRAMS_genusExtCode: dataValue('boat/catch_details/genus') }})(state),
  WCSPROGRAMS_SpeciesID_Species: await findValue({uuid: 'wcsprograms_speciesid', relation: 'WCSPROGRAMS_species', where: { WCSPROGRAMS_speciesExtCode: dataValue('boat/catch_details/species') }})(state),
  LocalName: x['boat/catch_details/local_name'],
  WCSPROGRAMS_SexID_Sex: await findValue({uuid: 'wcsprograms_sexid', relation: 'WCSPROGRAMS_sex', where: { WCSPROGRAMS_sexExtCode: dataValue('boat/catch_details/sex') }})(state),
  ...
  WCSPROGRAMS_YesnoID_DnaSampleCollected: await findValue({uuid: 'wcsprograms_yesnoid', relation: 'WCSPROGRAMS_yesno', where: { WCSPROGRAMS_yesnoExtCode: dataValue('boat/catch_details/dna_sample_collected') }})(state),
...
alterState(async state => {
 const dataArray = state.data['boat'] || [] 
          ...
          for (let x of dataArray) { 
            ...
            mapping.push({
  WCSPROGRAMS_YesnoID_BoatInfo: await findValue({uuid: 'wcsprograms_yesnoid', relation: 'WCSPROGRAMS_yesno', where: { WCSPROGRAMS_yesnoExtCode: dataValue('boat/boat_info') }})(state),
  WCSPROGRAMS_BoatID_BoatType: await findValue({uuid: 'wcsprograms_boatid', relation: 'WCSPROGRAMS_boat', where: { WCSPROGRAMS_boatExtCode: dataValue('boat/boat_type') }})(state),
  OtherBoat: x['boat/other_boat'],
  Crew: x['boat/crew'],
  WomenCrew: x['boat/women_crew'],
  Engine: x['boat/engine'],
  WCSPROGRAMS_GearID_PrimaryGear: await findValue({uuid: 'wcsprograms_gearid', relation: 'WCSPROGRAMS_gear', where: { WCSPROGRAMS_gearExtCode: dataValue('boat/primary_gear') }})(state),
  ...
  WCSPROGRAMS_UnitID_PrimaryMeshSizeUnit: await findValue({uuid: 'wcsprograms_unitid', relation: 'WCSPROGRAMS_unit', where: { WCSPROGRAMS_unitExtCode: dataValue('boat/primary_mesh_size_unit') }})(state),
  PrimaryLinesNb: x['boat/primary_lines_nb'],
  PrimaryHooksNb: x['boat/primary_hooks_nb'],
  PrimaryHookSize: x['boat/primary_hook_size'],
  WCSPROGRAMS_GearID_SecondaryGear: await findValue({uuid: 'wcsprograms_gearid', relation: 'WCSPROGRAMS_gear', where: { WCSPROGRAMS_gearExtCode: dataValue('boat/secondary_gear') }})(state),
  ...
  WCSPROGRAMS_UnitID_SecondaryMeshSizeUnit: await findValue({uuid: 'wcsprograms_unitid', relation: 'WCSPROGRAMS_unit', where: { WCSPROGRAMS_unitExtCode: dataValue('boat/secondary_mesh_size_unit') }})(state),
  ...
  WCSPROGRAMS_HabitatID_FishingHabitat: await findValue({uuid: 'wcsprograms_habitatid', relation: 'WCSPROGRAMS_habitat', where: { WCSPROGRAMS_habitatExtCode: dataValue('boat/fishing_habitat') }})(state),
  ...
  WCSPROGRAMS_YesnoID_Targeted: await findValue({uuid: 'wcsprograms_yesnoid', relation: 'WCSPROGRAMS_yesno', where: { WCSPROGRAMS_yesnoExtCode: dataValue('boat/targeted') }})(state),
  LastCatchSharkRay: x['boat/last_catch_shark_ray'],
  WCSPROGRAMS_YesnoID_ReleaseSharkRay: await findValue({uuid: 'wcsprograms_yesnoid', relation: 'WCSPROGRAMS_yesno', where: { WCSPROGRAMS_yesnoExtCode: dataValue('boat/release_shark_ray') }})(state),
...
each(dataPath('market_details[*]'), each(dataPath('vendor[*]'), alterState(async state => {
 const dataArray = state.data['market_details/vendor/sales/s_gear_type'] || [] 
          ...
          for (let x of dataArray) { 
            ...
            mapping.push({
  WCSPROGRAMS_GearID: await findValue({uuid: 'wcsprograms_gearid', relation: 'WCSPROGRAMS_Gear', where: { WCSPROGRAMS_GearExtCode: x }})(state),
 ...
 return upsertMany('WCSPROGRAMS_SalesGear', 'GeneratedUuid', () => mapping, {setNull: ["''", "'undefined'"]})(state); 
}) 
))
each(dataPath('boat[*]'), each(dataPath('catch_details[*]'), alterState(async state => {
 ...
 return upsertMany('WCSPROGRAMS_CatchDetailsGear', 'GeneratedUuid', () => mapping, {setNull: ["''", "'undefined'"]})(state); 
}) 
))
