...
alterState(async state => {
  ...
  return upsertIf(
    dataValue('survey_type'),
    'WCSPROGRAMS_SurveyType',
...
alterState(async state => {
  ...
  return upsertIf(
    dataValue('landing_site'),
    'WCSPROGRAMS_LandingSite',
    'WCSPROGRAMS_LandingSiteExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
...
alterState(async state => {
  ...
  return upsertIf(
    dataValue('boat/boat_info'),
    'WCSPROGRAMS_BoatInfo',
    'WCSPROGRAMS_BoatInfoExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
alterState(async state => {
  ...
  return upsertIf(
    dataValue('boat/boat_type'),
    'WCSPROGRAMS_BoatType',
    'WCSPROGRAMS_BoatTypeExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
alterState(async state => {
  ...
  return upsertIf(
    dataValue('boat/primary_gear'),
    'WCSPROGRAMS_PrimaryGear',
    'WCSPROGRAMS_PrimaryGearExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
alterState(async state => {
  const mapping = {
    WCSPROGRAMS_PrimaryMeshSizeUnitName: dataValue(
      'boat/primary_mesh_size_unit'
    ),
    WCSPROGRAMS_PrimaryMeshSizeUnitExtCode: dataValue(
      'boat/primary_mesh_size_unit'
    ),
    //Payload: state.data.body
  };
  return upsertIf(
    dataValue('boat/primary_mesh_size_unit'),
    'WCSPROGRAMS_PrimaryMeshSizeUnit',
    'WCSPROGRAMS_PrimaryMeshSizeUnitExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
alterState(async state => {
  ...
  return upsertIf(
    dataValue('boat/secondary_gear'),
    'WCSPROGRAMS_SecondaryGear',
    'WCSPROGRAMS_SecondaryGearExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
alterState(async state => {
  const mapping = {
    WCSPROGRAMS_SecondaryMeshSizeUnitName: dataValue(
      'boat/secondary_mesh_size_unit'
    ),
    WCSPROGRAMS_SecondaryMeshSizeUnitExtCode: dataValue(
      'boat/secondary_mesh_size_unit'
    ),
    //Payload: state.data.body
  };
  return upsertIf(
    dataValue('boat/secondary_mesh_size_unit'),
    'WCSPROGRAMS_SecondaryMeshSizeUnit',
    'WCSPROGRAMS_SecondaryMeshSizeUnitExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
alterState(async state => {
  ...
  return upsertIf(
    dataValue('boat/fishing_habitat'),
    'WCSPROGRAMS_FishingHabitat',
    'WCSPROGRAMS_FishingHabitatExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
alterState(async state => {
  ...
  return upsertIf(
    dataValue('boat/targeted'),
    'WCSPROGRAMS_Targeted',
    'WCSPROGRAMS_TargetedExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
alterState(async state => {
  ...
  return upsertIf(
    ...
    'WCSPROGRAMS_ReleaseSharkRay',
    'WCSPROGRAMS_ReleaseSharkRayExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
...
each(
  ...
  each(
    ...
    alterState(async state => {
      ...
      return upsertMany(
        'WCSPROGRAMS_CatchDetailsGearType',
        'GeneratedUuid',
        () => mapping,
        { setNull: ["''", "'undefined'"] }
      )(state);
...
alterState(async state => {
  const mapping = {
    WCSPROGRAMS_DnaSampleCollectedName: dataValue(
      'boat/catch_details/dna_sample_collected'
    ),
    WCSPROGRAMS_DnaSampleCollectedExtCode: dataValue(
      'boat/catch_details/dna_sample_collected'
    ),
    //Payload: state.data.body
  };
  return upsertIf(
    ...
    'WCSPROGRAMS_DnaSampleCollected',
    'WCSPROGRAMS_DnaSampleCollectedExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
alterState(async state => {
  ...
  return upsertIf(
    dataValue('boat/fish_catch/fish_specie'),
    'WCSPROGRAMS_FishSpecie',
    'WCSPROGRAMS_FishSpecieExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
alterState(async state => {
  ...
  return upsertIf(
    ...
    'WCSPROGRAMS_VendorSex',
    'WCSPROGRAMS_VendorSexExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
alterState(async state => {
  const mapping = {
    WCSPROGRAMS_WhereBoughtName: dataValue(
      'market_details/vendor/where_bought'
    ),
    WCSPROGRAMS_WhereBoughtExtCode: dataValue(
      'market_details/vendor/where_bought'
    ),
    //Payload: state.data.body
  };
  return upsertIf(
    ...
    'WCSPROGRAMS_WhereBought',
    'WCSPROGRAMS_WhereBoughtExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
alterState(async state => {
  const mapping = {
    ...
    WCSPROGRAMS_WhoSoldToExtCode: dataValue(
  ...
  return upsertIf(
    ...
    'WCSPROGRAMS_WhoSoldTo',
    'WCSPROGRAMS_WhoSoldToExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
...
alterState(async state => {
  const mapping = {
    WCSPROGRAMS_SSpeciesName: dataValue(
      'market_details/vendor/sales/s_species'
    ),
    WCSPROGRAMS_SSpeciesExtCode: dataValue(
      'market_details/vendor/sales/s_species'
    ),
    //Payload: state.data.body
  };
  return upsertIf(
    ...
    'WCSPROGRAMS_SSpecies',
    'WCSPROGRAMS_SSpeciesExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
...
alterState(async state => {
  const mapping = {
    WCSPROGRAMS_SDnaSampleCollectedName: dataValue(
      'market_details/vendor/sales/s_dna_sample_collected'
    ),
    WCSPROGRAMS_SDnaSampleCollectedExtCode: dataValue(
      'market_details/vendor/sales/s_dna_sample_collected'
    ),
    //Payload: state.data.body
  };
  return upsertIf(
    dataValue('market_details/vendor/sales/s_dna_sample_collected'),
    'WCSPROGRAMS_SDnaSampleCollected',
    'WCSPROGRAMS_SDnaSampleCollectedExtCode',
    mapping,
    { setNull: ["''", "'undefined'"] }
  )(state);
});
  ...
  alterState(async state => {
    ...
    for (let x of dataArray) {
      mapping.push({
        ...
        SDnaSampleCollected:
          x['market_details/vendor/sales/s_dna_sample_collected'],
