...
upsert('WCSPROGRAMS_KoboBnsAnswer', 'DatasetUuidId', {
  ...
  //HhId: dataValue('body.hh_id'), //temp commenting out until 'undefined' string issue resolved in LP
...
insert('WCSPROGRAMS_KoboBnsAnswergs', {
  ...
  necessary: dataValue('body.bns_matrix_machete/bns_matrix_machete_necessary'),
...
insert('WCSPROGRAMS_KoboBnsAnswergs', {
  ...
  have: dataValue('body.bns_matrix_hairdresser/bns_matrix_hairdresser_possess'),
  necessary: dataValue(
...
insert('WCSPROGRAMS_KoboBnsAnswergs', {
  ...
  quantity: dataValue('body.bns_matrix_cookstove/bns_matrix_cookstove_number'),
});
insert('WCSPROGRAMS_KoboBnsAnswergs', {
  AnswerId: state.data._id,
  gs: dataValue('body.bns_matrix_cookstove/bns_matrix_cookstove_note'),
...
insert('WCSPROGRAMS_KoboBnsAnswergs', {
  ...
  quantity: dataValue('body.bns_matrix_generator/bns_matrix_generator_number'),
});
insert('WCSPROGRAMS_KoboBnsAnswergs', {
  AnswerId: state.data._id,
  gs: dataValue(
...
insert('WCSPROGRAMS_KoboBnsAnswergs', {
  ...
  have: dataValue('body.bns_matrix_fishing_net/bns_matrix_fishing_net_possess'),
  necessary: dataValue(
...
insert('WCSPROGRAMS_KoboBnsAnswergs', {
  ...
  have: dataValue('body.bns_matrix_new_clothes/bns_matrix_new_clothes_possess'),
  necessary: dataValue(
...
insert('WCSPROGRAMS_KoboBnsAnswergs', {
  ...
  necessary: dataValue('body.bns_matrix_jewelry/bns_matrix_jewelry_necessary'),
...
insert('WCSPROGRAMS_KoboBnsAnswergs', {
  ...
  necessary: dataValue('body.bns_matrix_chicken/bns_matrix_chicken_necessary'),
...
insert('WCSPROGRAMS_KoboBnsAnswergs', {
  ...
  necessary: dataValue('body.bns_matrix_freezer/bns_matrix_freezer_necessary'),
...
insert('WCSPROGRAMS_KoboBnsAnswergs', {
  AnswerId: state.data._id,
  gs: dataValue('body.bns_matrix_field_half_ha/bns_matrix_field_half_ha_note'),
  have: dataValue(
