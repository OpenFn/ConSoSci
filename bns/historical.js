...
alterState(state => {
  ...
  state.data = {
    surveys: [
      ...
      //BNS
      // HH 2021 
      { id: 'aEMeCB6j4BfUVDF4FrGuKw', tag: 'bns_survey', name: 'Conso+BNS Bismarck 20210531 update', owner: 'wcs_bismarck', instance: 'WCS Bismarck unpublished data 2021'  }, // synced Feb 2022
      ...
      // Prices 2021
     { id: 'a6c9ZFyxqafvERK5eMeH7E', tag: 'bns_price', name: 'BNS Price Bismarck 20210531', owner: 'wcs_bismarck', instance: 'WCS Bismarck unpublished data 2021'}, // synced Feb 2022
